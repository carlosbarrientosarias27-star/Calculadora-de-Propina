...
def menu_interactivo():
    """
    Ejecuta el ciclo principal de la interfaz de usuario por consola.
    
    Captura las entradas del usuario (cuenta, tipo de propina, personas),
    coordina las llamadas a la lógica de cálculo y maneja excepciones
    para evitar que el programa se cierre por entradas inválidas.
    """
